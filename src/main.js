...
class Main extends React.Component {
  ...
  change = event => {
    if (event == 1) {
      ...
      console.log("test =" + json["element" + nbrsheet].json);
      if (canvas_home != undefined) {
        ...
        canvas._object[0].selectable = false;        
  ...
  menu = event => {
    if (event == 1) {
      ...
      if (getcookie("username") == null) {
        ...
        sheet = <Stat ref={(e) => {setStateMain = e}} func={this.turn} />;
      }
      this.setState(sheet);
      canvas = undefined;
    }
    ...
    return (
      <div onClick={e => this.turn()}>
        ...
        <ul id='home' onClick={e => this.turn()}>
          ...
          <li id='skill'><a onClick={e => this.menu(5)}>Stat & Bag</a></li>
