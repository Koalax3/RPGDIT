...
class Sheet extends React.Component {
    ...
    onglet = event => {
        if (event == 1) {
            ...
            b = 0;
            backg = Object
                .keys(this.state.misc)
                .map(key => <Image key={key} details={this.state.misc[key]} />);
            this.setState(skill);
        }
    }
    new = event => {
        ...
        return (<div id="sheet" onClick={this.turn}>
            ...
            <div id="group">
                <ul id='menu'>
                    ...
                    <li id='port'><a onClick={e => this.onglet(4)}>Portrait</a></li>
                    <li id='box'><a onClick={e => this.onglet(5)}>Misc</a></li>
